...
namespace CustomerSupport.BDContext
{
    ...
    public partial class MMEnterprisesEntities : DbContext
    {
        ...
        public virtual int GNJobNotificationMeeting(Nullable<int> intMintBefore)
        {
            var intMintBeforeParameter = intMintBefore.HasValue ?
                new ObjectParameter("intMintBefore", intMintBefore) :
                new ObjectParameter("intMintBefore", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GNJobNotificationMeeting", intMintBeforeParameter);
        }
    
        public virtual int GNJobNotificationTicketAboutToExpire(Nullable<int> intMintBefore)
        {
            var intMintBeforeParameter = intMintBefore.HasValue ?
                new ObjectParameter("intMintBefore", intMintBefore) :
                new ObjectParameter("intMintBefore", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GNJobNotificationTicketAboutToExpire", intMintBeforeParameter);
        }
    
        public virtual int GNJobNotificationTicketExpired()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GNJobNotificationTicketExpired");
        }
        ...
        public virtual ObjectResult<GNListStatusServiceType_Result> GNListStatusServiceType(Nullable<int> idServiceType, Nullable<int> idServiceStatus, Nullable<bool> btStatusServiceType, Nullable<bool> btStatusServiceStatus)
        {
            ...
            var btStatusServiceTypeParameter = btStatusServiceType.HasValue ?
                new ObjectParameter("btStatusServiceType", btStatusServiceType) :
                new ObjectParameter("btStatusServiceType", typeof(bool));
    
            var btStatusServiceStatusParameter = btStatusServiceStatus.HasValue ?
                new ObjectParameter("btStatusServiceStatus", btStatusServiceStatus) :
                new ObjectParameter("btStatusServiceStatus", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GNListStatusServiceType_Result>("GNListStatusServiceType", idServiceTypeParameter, idServiceStatusParameter, btStatusServiceTypeParameter, btStatusServiceStatusParameter);
        }
        ...
        public virtual int GNTranServiceRequestAssets(string transactionType, ObjectParameter idAsset, Nullable<int> idServiceRequest, Nullable<int> idAssetsType, string description, string beneficiaries, string administrators)
        {
            var transactionTypeParameter = transactionType != null ?
                new ObjectParameter("TransactionType", transactionType) :
                new ObjectParameter("TransactionType", typeof(string));
            ...
            var administratorsParameter = administrators != null ?
                new ObjectParameter("Administrators", administrators) :
                new ObjectParameter("Administrators", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GNTranServiceRequestAssets", transactionTypeParameter, idAsset, idServiceRequestParameter, idAssetsTypeParameter, descriptionParameter, beneficiariesParameter, administratorsParameter);
        }
